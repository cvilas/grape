...
- Extends functionality to custom types automatically for decomposable public structs
...
[Note 1] Schema-based methods require pre-processing IDLs to autogenerate code. This is an abomination. I want to write native code that meets project-specific language and coding guidelines. The current schemaless approach keeps this simplicity while automatically traversing decomposable public structs.
