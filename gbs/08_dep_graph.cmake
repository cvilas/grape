...
<title>GRAPE Dependency Graph</title>
<style>
...
fetch('dep_graph.svg').then(r=>r.text()).then(svgText=>{
  ...
  graphDiv.innerHTML='<p>Failed to load dep_graph.svg. Build target dep_graph first.</p><pre>'+String(err)+'</pre>';
});
</script>
</body>
</html>
