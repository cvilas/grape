...
public:
  using StatusCallback = std::function<void(const grape::robot::loco::Status&)>;
...
TeleopEmulator::TeleopEmulator(const std::string& robot_name, StatusCallback&& status_cb)
  ...
  , cmd_pub_(robot_name + grape::robot::loco::TeleopCommandTopic::TOPIC_SUFFIX)
  , status_sub_(robot_name + grape::robot::loco::StatusTopic::TOPIC_SUFFIX,
...
//=================================================================================================
TEST_CASE("Locomotion service behaviours", "[loco_service]") {
  ...
  auto test_service = grape::robot::loco::Service(ROBOT_NAME, robot_cb);
  ...
  test_service.send(grape::robot::loco::KeepAliveCmd{});
  ...
  std::this_thread::sleep_for(TIMEOUT_MARGIN + grape::robot::loco::Service::TELEOP_TIMEOUT);
  test_service.send(grape::robot::loco::KeepAliveCmd{});
