...
option(ENABLE_HARDENING "Enable compiler and standard library hardening" OFF)
...
option(ENABLE_LSAN "Enable run-time memory leak detector" OFF)
if(ENABLE_LSAN)
...
if(ENABLE_IWYU)
  find_program(IWYU_BIN NAMES include-what-you-use iwyu QUIET)
  if(NOT IWYU_BIN)
...
message(STATUS "\tENABLE_IWYU       : ${ENABLE_IWYU} (${IWYU_BIN})")
message(STATUS "\tENABLE_LINTER           : ${ENABLE_LINTER} (${LINTER_BIN})")
message(STATUS "\tLINTER_WARNING_IS_ERROR : ${LINTER_WARNING_IS_ERROR}")
