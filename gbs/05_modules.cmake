...
function(configure_modules)
  ...
  configure_file(${GBS_TEMPLATES_DIR}/doxyfile.in ${CMAKE_BINARY_DIR}/doxyfile @ONLY)
...
function(install_modules)
  ...
  foreach(module IN LISTS _enabled_modules_list)
    ...
    configure_package_config_file(
      ${GBS_TEMPLATES_DIR}/module-config.cmake.in
  ...
  configure_file(${GBS_TEMPLATES_DIR}/uninstall.sh.in "${CMAKE_BINARY_DIR}/uninstall.sh" @ONLY)
...
if(NOT CMAKE_CROSSCOMPILING)
  ...
  if(DOXYGEN_FOUND)
    ...
    message(STATUS "Documentation path: ${DOC_OUTPUT_PATH}")
    message(STATUS "To build documentation, call: cmake --build ${CMAKE_BINARY_DIR} --target docs")
  else()
