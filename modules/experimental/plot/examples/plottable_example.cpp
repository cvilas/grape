...
auto main() -> int {
  ...
  TemperatureSensor temp{
    .timestamp = SteadyNs{1'000'000ns},
  ...
  static_assert(grape::Plottable<TemperatureSensor>, 
                "TemperatureSensor should be Plottable");
  static_assert(grape::Plottable<VehicleState>, 
                "VehicleState should be Plottable");
