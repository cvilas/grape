...
TeleopEmulator::TeleopEmulator(const std::string& robot_name, StatusCallback&& status_cb)
  ...
  , cmd_pub_(robot_name + grape::locomotion::AlternateCommandTopic::TOPIC_SUFFIX)
  , status_sub_(robot_name + grape::locomotion::ArbiterStatusTopic::TOPIC_SUFFIX,
...
void TeleopEmulator::onStatus(const grape::ipc::Sample& sample) {
  ...
  auto val = grape::locomotion::ArbiterStatusTopic::DataType{};
