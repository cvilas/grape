...
//-------------------------------------------------------------------------------------------------
// Demonstrates using libcamera to acquire and show camera frames from Raspberry Pi camera.
// Uses SDL3 for display rendering.
//-------------------------------------------------------------------------------------------------
...
auto SDL_AppInit(void** appstate, int argc, char* argv[]) -> SDL_AppResult {
  try {
    ...
    const auto args = grape::conio::ProgramDescription("Raspberry Pi camera viewer application")
